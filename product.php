...
?>
        <div class="content-wraper">
            <div class="container">
                ...
                <div class="your-new-class-1 your-new-class-2">
                    <div class="your-new-class-3 your-new-class-4">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                ...
                                ?>
                                        <div class="lg-image" style="display: flex; justify-content: center; align-items: center;">
                        ...
                        <div class="product-details-view-content ">
                            <div class="product-info">
                                <div class="product-desc">
                                    ...
                                    <div class="price-box">
                                        <span class="new-price new-price-2" style="color: Black; font-size: 24px;">ราคา : <?php echo number_format($row['price'], 0); ?> บาท</span>
                                        <p></p>
                                        <span class="who" style="color: #666666;">ลงขายโดย : <?php echo $row['user_name']; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="Details">
